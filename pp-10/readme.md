...
The HTML I would need to change to obtain the alternate site would be to remove "I'm feeling lucky" button and resizing and repositioning the "Search now" button into a smaller and more universally understood magnifying glass button next to the text field.